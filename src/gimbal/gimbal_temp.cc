...
namespace Gimbal
{
    ...
    void GimbalT::init(const std::shared_ptr<Robot::Robot_set> &robot) {
        ...
        pitch_relative_pid = Pid::PidRad(config.pitch_relative_pid_config, pitch_relative);
    ...
    void GimbalT::init_task() {
        ...
        std::cout << "yaw now: " << imu.yaw << ", " << imu.pitch << std::endl;
            ...
            0.f >> pitch_relative_pid >> pitch_motor;
            // LOG_INFO(
            //    "imu : %6f %6f %6f %6d\n",
            //    imu.yaw,
            //    imu.pitch,
            ...
            LOG_INFO("pitch ecd %d %f\n", pitch_motor.motor_measure_.ecd, pitch_relative);
...
#include "deque"
    ...
    [[noreturn]] void GimbalT::task() {
        ...
        while (true) {
            ...
            if (robot_set->mode == Types::ROBOT_MODE::ROBOT_NO_FORCE) {
                ...
                *pitch_set >> pitch_relative_pid >> pitch_motor;
            }
    ...
    void GimbalT::update_data() {
        ...
        pitch_relative = UserLib::rad_format(
            pitch_motor.data_.rotor_angle -
            Hardware::DJIMotor::ECD_8192_TO_RAD * config.PitchOffSet);
